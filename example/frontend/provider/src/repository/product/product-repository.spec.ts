...
describe('Product Repository', () => {
  ...
  it('should save new product in list products', async () => {
    ...
    await productRepository.store(6, 'Any_Type', 'Any_Name');

    const product = await productRepository.getById(6)
    expect(product).toEqual({ id: 6, type: 'Any_Type', name: 'Any_Name' })
  });
