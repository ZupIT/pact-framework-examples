...
class ClientStubTest {
    ...
    @Test
    fun `ClientStub class should has 10 ClientEntity`() {
        ...
        (1..numberOfStubs).forEach { id ->
            ...
            Assertions.assertThat(ClientEntity(id, id, "", "", 18))
                    ...
                    .ignoringFields("firstName", "lastName", "age")
                    .isEqualTo(actualEntity)
            Assertions.assertThat(actualEntity?.firstName).isNotBlank()
            Assertions.assertThat(actualEntity?.lastName).isNotBlank()
