...
def jobs = [
        [
                ...
                scriptPath: "examples/frontend/consumer/Jenkinsfile",
                resources: {
                    remote {
                        url(repository)
                    }
        ...
        [
                ...
                scriptPath: "examples/frontend/provider/Jenkinsfile",
                resources: {
                    remote {
                        url(repository)
                    }
        ...
        [
                ...
                scriptPath: "examples/ci/jenkins/cenario_1/pact-consumer-sample/Jenkinsfile",
                resources: {
                    remote {
                        url(repository)
                    }
        ...
        [
                ...
                scriptPath: "examples/ci/jenkins/cenario_1/pact-provider-sample/Jenkinsfile",
                resources: {
                    remote {
                        url(repository)
                    }
        ...
        [
                ...
                scriptPath: "examples/ci/jenkins/cenario_1/pact-consumer-sample/Jenkinsfile-can-i-deploy",
                resources: {
                    remote {
                        url(repository)
                    }
        ...
        [
                ...
                scriptPath: "examples/ci/jenkins/cenario_2/pact-provider-sample/Jenkinsfile",
                resources: {
                    remote {
                        url(repository)
                    }
        ...
        [
                ...
                scriptPath: "examples/ci/jenkins/cenario_3/pact-consumer-sample/Jenkinsfile",
                resources: {
                    remote {
                        url(repository)
                    }
        ...
        [
                ...
                scriptPath: "examples/ci/jenkins/cenario_3/pact-provider-sample/Jenkinsfile",
                resources: {
                    remote {
                        url(repository)
                    }
        ...
        [
                ...
                description: "Utilitário can-i-deploy diz se o contrato está seguro",
                scriptPath: "examples/ci/jenkins/cenario_1/pact-provider-sample/Jenkinsfile-can-i-deploy",
                resources: {
                    remote {
                        url(repository)
                    }
